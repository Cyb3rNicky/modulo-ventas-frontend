...
import { createVehiculo } from '../../services/Vehiculos/createVehiculos'
    ...
    <form onSubmit={onSubmit}>
      <div className="space-y-12">
        <div className="border-b border-gray-900/10 pb-12">
          <h2 className="text-base/7 font-semibold text-gray-900">Crear Vehículo</h2>
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="sm:col-span-3">
              ...
              <input id="anio" name="anio" type="number" value={form.anio} onChange={onChange}
                required className="mt-2 block w-full rounded-md bg-white px-3 py-1.5 text-base outline-1 -outline-offset-1 outline-gray-300 sm:text-sm/6" placeholder="2020" />
            </div>
            ...
            <div className="sm:col-span-3">
              ...
              <input id="precio" name="precio" type="number" step="0.01" value={form.precio} onChange={onChange}
                required className="mt-2 block w-full rounded-md bg-white px-3 py-1.5 text-base outline-1 -outline-offset-1 outline-gray-300 sm:text-sm/6" placeholder="125000" />
            </div>
          </div>
        </div>
      </div>
